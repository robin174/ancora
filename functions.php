<?php
/**
* ancoracapital functions and definitions
...
function ancoracapital_scripts() {

    // load Bootstrap CSS v5.1
    wp_enqueue_style( 'ancoracapital-bootstrap-css', THEME_DIR_URI . '/includes/css/bootstrap.min.css');

    // load website CSS, versioned
    wp_enqueue_style( 'ancoracapital-css', THEME_DIR_URI . '/assets/css/style.css', [], filemtime( get_stylesheet_directory() . '/assets/css/style.css') );

	// load Bootstrap JS v5.1
	wp_enqueue_script( 'ancoracapital-bootstrap-js', THEME_DIR_URI . '/includes/js/bootstrap.min.js', array('jquery') );
}
add_action( 'wp_enqueue_scripts', 'ancoracapital_scripts' );
...
/* Register menus */
if ( ! function_exists( 'ancoracapital_setup' ) ) :
	function ancoracapital_setup() {

    register_nav_menus( array(
        'primary' => __( 'Primary Menu', 'ancoracapital' ),
        'footer'  => __( 'Footer Menu', 'ancoracapital' ),
    ) );
...
add_action( 'after_setup_theme', 'ancoracapital_setup');
